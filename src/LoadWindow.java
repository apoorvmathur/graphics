...
public class LoadWindow extends JDialog {
	...
	public LoadWindow(GUI gui) {
		...
		JLabel lblSaveTo = new JLabel("Load from");
				...
				.setHorizontalGroup(
						gl_contentPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
										...
										.addComponent(textField, GroupLayout.PREFERRED_SIZE, 262,
	...
	protected void ok() {
		if (!textField.getText().equals("")) {
			...
			try {
				gui.panel_2.removeAllShapes();
				gui.panel_2.restore(file);
				gui.panel_2.repaint();
			} catch (IOException e) {
				e.printStackTrace();
			}
